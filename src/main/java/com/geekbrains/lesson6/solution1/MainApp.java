package com.geekbrains.lesson6.solution1;
...
public class MainApp {
    ...
    static void singleThread(float[] arr) {
        ...
        new RunnableClass(arr).doSomeThing();
    ...
    static void multiThread(float[] arr) throws InterruptedException {
        ...
        Thread t1 = new Thread(new RunnableClass(arrHalf1));
        Thread t2 = new Thread(new RunnableClass(arrHalf2));
